  ...
  return (
    <div className="card-body px-5 mx-5">
      <p className="card-text  px-5 mx-5">
        ...
        I leverage my knowledge in hardware platforms and operating systems to
        build out fully functional web apps.
        <br />
        Looking to leverage my passion for problem solving heightened by my
        technical knowledge into a role as a software engineer.
      </p>
    </div>
  )
}
